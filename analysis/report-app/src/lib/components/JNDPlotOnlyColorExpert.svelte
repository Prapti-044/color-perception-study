		...
		chart = new Chart(chartCanvas, {
			...
			options: {
				...
				plugins: {
					...
					title: {
						display: true,
						text: '50% JND: Only Color Expert (without occasional makeup users) vs Non-Expert',
						font: {
							size: 18,
							weight: 'bold'
						},
...
<Section title="50% JND Comparison: Only Color Expert (without occasional makeup users) vs Non-Expert">
	<!-- Group Definitions -->
	...
	<div class="mb-6 space-y-4">
		<div class="rounded-lg bg-slate-50 p-6 border border-slate-200">
			...
			<div class="grid gap-4 md:grid-cols-2">
				...
				<div>
					<h4 class="mb-3 text-sm font-semibold text-blue-700">Only Color Expert Group</h4>
	...
	<div class="mt-8 rounded-lg bg-white p-6 shadow-sm border border-slate-200">
		<h3 class="mb-4 text-lg font-semibold text-slate-700">50% JND Comparison: Only Color Expert vs Non-Expert</h3>
		<div class="h-[500px]">
	...
	<p class="mt-4 text-sm text-slate-600 italic">
		<strong>Figure:</strong> 50% JND (ND(50%, s)) as a function of point diameter, comparing Only Color Expert participants 
		(regular/professional makeup users or color theory background, excluding occasional makeup users) versus Non-Expert participants. 
